<template>
  ...
  <footer class="text-center text-lg-start bg-light text-muted">
    <div class="container">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <h6 class="text-uppercase fw-bold mb-4">
                <i class="fas fa-gem me-3"></i>sisampah
              </h6>
              <p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p><i class="fas fa-home me-3"></i> Batang, Jawa Tengah</p>
              <p>
                <i class="fas fa-envelope me-3"></i>
                muslihmaulanam3@gmail.com
              </p>
              <p><i class="fas fa-phone me-3"></i> +628818669227</p>
            </div>
            <!-- Grid column -->
          </div>
          <!-- Grid row -->
      ...
      >
        © 2023 Copyright:
        <a class="text-reset fw-bold" href="https://wa.me/628818669227"
          >sisampah</a
        >
      </div>
      <!-- Copyright -->
